---
description: This creates a detailed context summary that can be used to continue work in a new session.
---
...
1. Type '/new' in to open a new session
2. Paste the HANDOFF CONTEXT above as your first message
3. Add your request (option): "Continue from the handoff context above. [Your next task]"
